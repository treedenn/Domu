...
public interface IHouseholdMembershipRepository
{
    ...
    Task<IReadOnlyList<HouseholdInvitation>> GetPendingInvitationsAsync(Guid householdId,
        CancellationToken cancellationToken);

    Task<HouseholdInvitation?> GetPendingInvitationByEmailAsync(Guid householdId, string email,
        CancellationToken cancellationToken);
