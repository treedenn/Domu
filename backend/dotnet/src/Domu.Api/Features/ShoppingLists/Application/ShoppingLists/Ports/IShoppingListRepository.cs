...
{
    Task<IReadOnlyList<ShoppingList>> GetActiveByHouseholdAsync(Guid householdId, CancellationToken cancellationToken);
    ...
    Task UpdateAsync(ShoppingList shoppingList, CancellationToken cancellationToken);
