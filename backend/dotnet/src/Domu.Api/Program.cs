...
builder.Services.AddScoped<IGetOrCreateDefaultShoppingListUseCase, GetOrCreateDefaultShoppingListUseCase>();
builder.Services.AddScoped<IGetShoppingListItemsUseCase, GetShoppingListItemsUseCase>();
builder.Services.AddScoped<ICreateShoppingListItemUseCase, CreateShoppingListItemUseCase>();
builder.Services.AddScoped<IUpdateShoppingListItemUseCase, UpdateShoppingListItemUseCase>();
builder.Services.AddScoped<ICheckShoppingListItemUseCase, CheckShoppingListItemUseCase>();
builder.Services.AddScoped<IUncheckShoppingListItemUseCase, UncheckShoppingListItemUseCase>();
builder.Services.AddScoped<IDeleteShoppingListItemUseCase, DeleteShoppingListItemUseCase>();
builder.Services.AddScoped<IClearCheckedShoppingListItemsUseCase, ClearCheckedShoppingListItemsUseCase>();
